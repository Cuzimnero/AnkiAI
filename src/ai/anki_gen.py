...
class AnkiGen:
    ...
    def rework_part(self,cards: list[dict],context:str):
        system_prompt = f"""
                ...
                RULES:
                1. MERGE: Combine cards that cover the exact same topic (e.g., individual GDPR principles) into a single, comprehensive card.
                2. DELETE: Remove all cards regarding organizational data, job offers, university-specific meta-info.
                3. DEDUPLICATE: Identify and remove nearly identical questions. But be careful dont delete to much.

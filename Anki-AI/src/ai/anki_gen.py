...
class AnkiGen:
    ...
    def rework(self, cards: list[dict],requirements:str):
        ...
        5. Use every instructions here: {requirements}
    ...
    def createCards(self,path: Path,context:str,language:str,req:str):
        print("t")
        cards=[]
        all_cards=[]
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=20) as executor:
            ...
            for future in concurrent.futures.as_completed(cards):
                try:
                 ...
                 print(f"Fehler: {e}")
        print("rework")
        final_cards=self.rework(all_cards,req)
        print(final_cards)
        return final_cards

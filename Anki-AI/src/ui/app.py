...
class App(ctk.CTk, TkinterDnD.DnDWrapper):
    ...
    def open_details_window(self):
        ...
        self.details_window.geometry("400x590")
    ...
    def start_generation(self):
        self.start_btn.configure(state="disabled",text="Generiere Karten...")
    ...
    def run_gen(self):
        ...
        cards= generator.createCards(self.selected_file,context,self.lang_switch.get(),self.req_text.get("1.0","end-1c"))
